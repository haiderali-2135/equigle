...
import { Mail, Phone, Send, Linkedin, Instagram, Twitter } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70">
            Get in Touch
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Have a project in mind or want to learn more? We'd love to hear from
            you.
          </p>
        </motion.div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-sm text-purple-400 hover:text-purple-300 transition-colors"
                    >
                      Call us <Send className="ml-1 h-3 w-3" />
                    </a>
                  </div>
                </div>
              </div>
