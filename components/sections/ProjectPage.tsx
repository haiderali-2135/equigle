...
export default function ProjectPage() {
  ...
  useEffect(() => {
    if (params.id) {
      const foundProject = projects.find((p) => p.P_id === params.id);
      if (foundProject) {
        ...
        <div className="container mx-auto px-6 py-16">
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <p className="text-white/80 mb-8">
                  ...
                  {project.industry} industry, focusing on delivering
                  high-quality solutions that meet specific business needs.
                </p>
          ...
          <div className="mt-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects
                .filter(
                  (p) => p.category === project.category && p.P_id !== project.P_id
                )
                .slice(0, 3)
                .map((relatedProject) => (
                  <Link
                    href={`/project/${relatedProject.P_id}`}
                    key={relatedProject.P_id}
                  >
